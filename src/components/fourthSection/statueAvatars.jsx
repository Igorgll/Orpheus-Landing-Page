    ...
    return (
      <Container className="container-fluid mt-5 mb-5">
        <div
          ...
          id="rowThirdSectionAvatars"
        >
          <div className="col-md-6" id="greek_statue_div">
            <h1 className="text-center display-5" id="row_headingAvatars">
              Greek Statue Avatars
            </h1>
            <h2 className="text-center mt-4 lh-base" id="row_subHeadingAvatars">
              +500 Greek style <span id="span200">User Avatars</span>
            </h2>
